...
all: ubuntu18.10 ubuntu16.04 ubuntu14.04 debian9 debian8 centos7 amzn2 amzn1

ubuntu18.10: $(addsuffix -ubuntu18.10, 18.09.3 18.06.2 18.09.1 18.09.0 18.06.1 18.06.0 18.03.1 17.12.1)

ubuntu16.04: $(addsuffix -ubuntu16.04, 18.09.3 18.06.2 18.09.1 18.09.0 18.06.1 18.06.0 18.03.1 18.03.0 17.12.1 17.12.0 17.09.1 17.09.0 17.06.2 17.03.2 1.13.1 1.12.6)

ubuntu14.04: $(addsuffix -ubuntu14.04, 18.09.3 18.06.2 18.06.1 18.06.0 18.03.1 18.03.0 17.12.1 17.09.1 17.06.2 17.03.2)

debian9: $(addsuffix -debian9, 18.09.3 18.06.2 18.09.1 18.09.0 18.06.1 18.06.0 18.03.1 18.03.0 17.12.1 17.12.0 17.09.1 17.09.0 17.06.2 17.03.2)

debian8: $(addsuffix -debian8, 18.06.2 18.06.1 18.06.0 18.03.1 18.03.0 17.12.1 17.09.1 17.06.2)

centos7: $(addsuffix -centos7, 18.09.3.ce 18.06.2.ce 18.09.1.ce 18.09.0.ce 18.06.1.ce 18.06.0.ce 18.03.1.ce 18.03.0.ce 17.12.1.ce 17.12.0.ce 17.09.1.ce 17.09.0.ce 17.06.2.ce 17.03.2.ce 1.13.1 1.12.6)
...
18.09.3-ubuntu18.10: ARCH := amd64
18.09.3-ubuntu18.10:
	$(DOCKER) build --build-arg VERSION_ID="18.10" \
                        --build-arg RUNTIME_VERSION="$(RUNTIME_VERSION)+docker18.09.3-1" \
                        --build-arg DOCKER_VERSION="docker-ce (= 5:18.09.3~3-0~ubuntu-cosmic) | docker-ee (= 5:18.09.3~3-0~ubuntu-cosmic)" \
                        --build-arg PKG_VERS="$(VERSION)+docker18.09.3" \
                        --build-arg PKG_REV="$(PKG_REV)" \
                        -t "nvidia/nvidia-docker2/ubuntu:18.10-docker18.09.3" -f Dockerfile.ubuntu .
	$(MKDIR) -p $(DIST_DIR)/ubuntu18.10/$(ARCH)
	$(DOCKER) run  --cidfile $@.cid "nvidia/nvidia-docker2/ubuntu:18.10-docker18.09.3"
	$(DOCKER) cp $$(cat $@.cid):/dist/. $(DIST_DIR)/ubuntu18.10/$(ARCH)
	$(DOCKER) rm $$(cat $@.cid) && rm $@.cid

18.09.1-ubuntu18.10: ARCH := amd64
18.09.1-ubuntu18.10:
	$(DOCKER) build --build-arg VERSION_ID="18.10" \
                        --build-arg RUNTIME_VERSION="$(RUNTIME_VERSION)+docker18.09.1-1" \
                        --build-arg DOCKER_VERSION="docker-ce (= 5:18.09.1~3-0~ubuntu-cosmic) | docker-ee (= 5:18.09.1~3-0~ubuntu-cosmic)" \
                        --build-arg PKG_VERS="$(VERSION)+docker18.09.1" \
                        --build-arg PKG_REV="$(PKG_REV)" \
                        -t "nvidia/nvidia-docker2/ubuntu:18.10-docker18.09.1" -f Dockerfile.ubuntu .
	$(MKDIR) -p $(DIST_DIR)/ubuntu18.10/$(ARCH)
	$(DOCKER) run  --cidfile $@.cid "nvidia/nvidia-docker2/ubuntu:18.10-docker18.09.1"
	$(DOCKER) cp $$(cat $@.cid):/dist/. $(DIST_DIR)/ubuntu18.10/$(ARCH)
	$(DOCKER) rm $$(cat $@.cid) && rm $@.cid

18.09.0-ubuntu18.10: ARCH := amd64
18.09.0-ubuntu18.10:
	$(DOCKER) build --build-arg VERSION_ID="18.10" \
                        --build-arg RUNTIME_VERSION="$(RUNTIME_VERSION)+docker18.09.0-1" \
                        --build-arg DOCKER_VERSION="docker-ce (= 5:18.09.0~3-0~ubuntu-cosmic) | docker-ee (= 5:18.09.0~3-0~ubuntu-cosmic)" \
                        --build-arg PKG_VERS="$(VERSION)+docker18.09.0" \
                        --build-arg PKG_REV="$(PKG_REV)" \
                        -t "nvidia/nvidia-docker2/ubuntu:18.10-docker18.09.0" -f Dockerfile.ubuntu .
	$(MKDIR) -p $(DIST_DIR)/ubuntu18.10/$(ARCH)
	$(DOCKER) run  --cidfile $@.cid "nvidia/nvidia-docker2/ubuntu:18.10-docker18.09.0"
	$(DOCKER) cp $$(cat $@.cid):/dist/. $(DIST_DIR)/ubuntu18.10/$(ARCH)
	$(DOCKER) rm $$(cat $@.cid) && rm $@.cid

18.06.2-ubuntu18.10: ARCH := amd64
18.06.2-ubuntu18.10:
	$(DOCKER) build --build-arg VERSION_ID="18.10" \
                        ...
                        --build-arg PKG_REV="$(PKG_REV)" \
                        -t "nvidia/nvidia-docker2/ubuntu:18.10-docker18.06.2" -f Dockerfile.ubuntu .
	$(MKDIR) -p $(DIST_DIR)/ubuntu18.10/$(ARCH)
	$(DOCKER) run  --cidfile $@.cid "nvidia/nvidia-docker2/ubuntu:18.10-docker18.06.2"
	$(DOCKER) cp $$(cat $@.cid):/dist/. $(DIST_DIR)/ubuntu18.10/$(ARCH)
	$(DOCKER) rm $$(cat $@.cid) && rm $@.cid

18.06.1-ubuntu18.10: ARCH := amd64
18.06.1-ubuntu18.10:
	$(DOCKER) build --build-arg VERSION_ID="18.10" \
                        ...
                        --build-arg PKG_REV="$(PKG_REV)" \
                        -t "nvidia/nvidia-docker2/ubuntu:18.10-docker18.06.1" -f Dockerfile.ubuntu .
	$(MKDIR) -p $(DIST_DIR)/ubuntu18.10/$(ARCH)
	$(DOCKER) run  --cidfile $@.cid "nvidia/nvidia-docker2/ubuntu:18.10-docker18.06.1"
	$(DOCKER) cp $$(cat $@.cid):/dist/. $(DIST_DIR)/ubuntu18.10/$(ARCH)
	$(DOCKER) rm $$(cat $@.cid) && rm $@.cid

18.06.0-ubuntu18.10: ARCH := amd64
18.06.0-ubuntu18.10:
	$(DOCKER) build --build-arg VERSION_ID="18.10" \
                        ...
                        --build-arg PKG_REV="$(PKG_REV)" \
                        -t "nvidia/nvidia-docker2/ubuntu:18.10-docker18.06.0" -f Dockerfile.ubuntu .
	$(MKDIR) -p $(DIST_DIR)/ubuntu18.10/$(ARCH)
	$(DOCKER) run  --cidfile $@.cid "nvidia/nvidia-docker2/ubuntu:18.10-docker18.06.0"
	$(DOCKER) cp $$(cat $@.cid):/dist/. $(DIST_DIR)/ubuntu18.10/$(ARCH)
	$(DOCKER) rm $$(cat $@.cid) && rm $@.cid

18.03.1-ubuntu18.10: ARCH := amd64
18.03.1-ubuntu18.10:
	$(DOCKER) build --build-arg VERSION_ID="18.10" \
                        ...
                        --build-arg PKG_REV="$(PKG_REV)" \
                        -t "nvidia/nvidia-docker2/ubuntu:18.10-docker18.03.1" -f Dockerfile.ubuntu .
	$(MKDIR) -p $(DIST_DIR)/ubuntu18.10/$(ARCH)
	$(DOCKER) run  --cidfile $@.cid "nvidia/nvidia-docker2/ubuntu:18.10-docker18.03.1"
	$(DOCKER) cp $$(cat $@.cid):/dist/. $(DIST_DIR)/ubuntu18.10/$(ARCH)
	$(DOCKER) rm $$(cat $@.cid) && rm $@.cid

17.12.1-ubuntu18.10: ARCH := amd64
17.12.1-ubuntu18.10:
	$(DOCKER) build --build-arg VERSION_ID="18.10" \
                        ...
                        --build-arg PKG_REV="$(PKG_REV)" \
                        -t "nvidia/nvidia-docker2/ubuntu:18.10-docker17.12.1" -f Dockerfile.ubuntu .
	$(MKDIR) -p $(DIST_DIR)/ubuntu18.10/$(ARCH)
	$(DOCKER) run  --cidfile $@.cid "nvidia/nvidia-docker2/ubuntu:18.10-docker17.12.1"
	$(DOCKER) cp $$(cat $@.cid):/dist/. $(DIST_DIR)/ubuntu18.10/$(ARCH)
	$(DOCKER) rm $$(cat $@.cid) && rm $@.cid
...
18.09.3-ubuntu16.04: ARCH := amd64
18.09.3-ubuntu16.04:
	$(DOCKER) build --build-arg VERSION_ID="16.04" \
                        --build-arg RUNTIME_VERSION="$(RUNTIME_VERSION)+docker18.09.3-1" \
                        --build-arg DOCKER_VERSION="docker-ce (= 5:18.09.3~3-0~ubuntu-xenial) | docker-ee (= 5:18.09.3~3-0~ubuntu-xenial)" \
                        --build-arg PKG_VERS="$(VERSION)+docker18.09.3" \
                        --build-arg PKG_REV="$(PKG_REV)" \
                        -t "nvidia/nvidia-docker2/ubuntu:16.04-docker18.09.3" -f Dockerfile.ubuntu .
	$(MKDIR) -p $(DIST_DIR)/ubuntu16.04/$(ARCH)
	$(DOCKER) run  --cidfile $@.cid "nvidia/nvidia-docker2/ubuntu:16.04-docker18.09.3"
	$(DOCKER) cp $$(cat $@.cid):/dist/. $(DIST_DIR)/ubuntu16.04/$(ARCH)
	$(DOCKER) rm $$(cat $@.cid) && rm $@.cid
...
18.09.3-debian9: ARCH := amd64
18.09.3-debian9:
	$(DOCKER) build --build-arg VERSION_ID="9" \
                        --build-arg RUNTIME_VERSION="$(RUNTIME_VERSION)+docker18.09.3-1" \
                        --build-arg DOCKER_VERSION="docker-ce (= 5:18.09.3~3-0~debian-stretch)" \
                        --build-arg PKG_VERS="$(VERSION)+docker18.09.3" \
                        --build-arg PKG_REV="$(PKG_REV)" \
                        -t "nvidia/nvidia-docker2/debian:9-docker18.09.3" -f Dockerfile.debian .
	$(MKDIR) -p $(DIST_DIR)/debian9/$(ARCH)
	$(DOCKER) run  --cidfile $@.cid "nvidia/nvidia-docker2/debian:9-docker18.09.3"
	$(DOCKER) cp $$(cat $@.cid):/dist/. $(DIST_DIR)/debian9/$(ARCH)
	$(DOCKER) rm $$(cat $@.cid) && rm $@.cid
...
18.09.3.ce-centos7: ARCH := x86_64
18.09.3.ce-centos7:
	$(DOCKER) build --build-arg VERSION_ID="7" \
                        --build-arg RUNTIME_VERSION="$(RUNTIME_VERSION)-1.docker18.09.3" \
                        --build-arg DOCKER_VERSION="docker-ce = 3:18.09.3" \
                        --build-arg PKG_VERS="$(VERSION)" \
                        --build-arg PKG_REV="$(PKG_REV).docker18.09.3.ce" \
                        -t "nvidia/nvidia-docker2/centos:7-docker18.09.3.ce" -f Dockerfile.centos .
	$(MKDIR) -p $(DIST_DIR)/centos7/$(ARCH)
	$(DOCKER) run  --cidfile $@.cid "nvidia/nvidia-docker2/centos:7-docker18.09.3.ce"
	$(DOCKER) cp $$(cat $@.cid):/dist/. $(DIST_DIR)/centos7/$(ARCH)
	$(DOCKER) rm $$(cat $@.cid) && rm $@.cid
